...
import { Home, Search, Mail, Scale } from 'lucide-react';
import Container from '@/components/ui/Container';

// Shared by both 404 surfaces so they can't drift apart:
//   (public)/not-found.tsx  — inside the site chrome, needs the fixed
//                             navbar cleared with top padding
//   app/not-found.tsx       — bare fallback with no chrome, so no offset
// The caller supplies that spacing via `className`; everything visual
// lives here.
const quickLinks = [
...
export default function NotFoundContent({
  ...
  return (
    ...
    >
      ...
      {/* Scales of justice, not the cogs this template shipped with —
          gears read as an engineering faculty, which this is not. */}
      <Scale
      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-2xl text-center">
          ...
          {/* Plays on the two senses of "order" — a court order, and
              something being out of order. The badge above already
              states the literal meaning, which is what frees the
              heading to be playful without leaving anyone guessing. */}
          <h2 className="font-display text-3xl md:text-4xl font-bold text-primary mb-4">
            This page is out of order.
          </h2>

          <p className="text-base md:text-lg text-gray-600 leading-relaxed mb-10">
            No ruling required — the page you were looking for simply
            doesn&apos;t exist or may have moved. Try one of the links below,
